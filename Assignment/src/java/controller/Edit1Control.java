 ...
 * @author Admin
 */
public class Edit1Control extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        DAO dao = new DAO();
        dao.editProduct(pname, pimage, pprice, pquantity, ptitle, pdescription, pcategory, pbrand, pmodel, pcolor, pdelivery, pimage2, pimage3, pimage4, pid);
