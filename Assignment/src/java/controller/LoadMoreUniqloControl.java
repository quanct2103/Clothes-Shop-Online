 ...
 * @author Admin
 */
public class LoadMoreUniqloControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String amount = request.getParameter("exitsUniqlo");
        int iamount = Integer.parseInt(amount);
        DAO dao = new DAO();
        List<SanPham> list = dao.getNext4UniqloProduct(iamount);
        PrintWriter out = response.getWriter();

        for (SanPham o : list) {
            out.println("<div class=\"productUniqlo col-12 col-md-6 col-lg-3\"> "
            		+ "                                <div class=\"card\"> "
